    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        changeURl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(inventory.this, changeURL.class));
        ...
        stocktake.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(inventory.this, stocktake.class));
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(inventory.this, MainActivity3.class));
